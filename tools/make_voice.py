...
PHRASES = [
    ...
    "Slaan met het paard! Het paard springt in een L. Tik op je paard dat oplicht, en sla daarmee de toren.",
    "Hebbes! Een toren gepakt met je paard. Vijf punten gewonnen!",
    "Tik op je paard dat oplicht, en spring naar de toren die het handje aanwijst.",
    "Nu met de dame. Tik op je dame, en sla daarmee de toren.",
    "Knap! Je dame pakte de toren.",
    "Tik op je dame die oplicht, en pak dan de toren die het handje aanwijst.",
    "Je kunt twee stukken pakken: een paard van drie punten, of een toren van vijf. Tik op je dame en pak de sterkste, dat is de toren!",
    ...
    "Nu goed opletten! De loper wordt verdedigd door een pion, maar de toren staat helemaal alleen. Tik op je dame en pak de toren die alleen staat.",
