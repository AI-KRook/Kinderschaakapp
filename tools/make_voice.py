...
PHRASES = [
    ...
    # module 2: de stukken
    "We gaan de stukken leren kennen. Eentje tegelijk, rustig aan.",
    "Dit is de toren. Hij rijdt kaarsrecht: naar voren, naar achteren, of opzij. Net een trein op de rails!",
    "Dit is de loper. Hij schuift altijd schuin, lekker glijden, net een schaatser op het ijs!",
    "Dit is het paard. Dat ben ik! Ik spring in de vorm van een letter L: twee stapjes vooruit en dan eentje opzij. Hop! En ik mag zelfs over andere stukken heen springen.",
    "Dit is de dame. Zij is de allersterkste! Zij mag rechtdoor en schuin, dus echt alle kanten op.",
    "Dit is de koning. Hij is de baas, maar een beetje langzaam. Hij zet steeds maar één klein stapje.",
    "Dit is de pion, het kleinste soldaatje. Hij stapt vooruit, eentje tegelijk. Alleen de eerste keer mag hij er twee. Maar nooit achteruit!",
    "Tik op het stuk. De groene stipjes laten zien waar hij naartoe mag.",
    "Probeer maar: kun jij het sterretje pakken?",
    "Wauw, je kent nu alle stukken! Wat heb jij dat snel geleerd.",
    # module 3: slaan
    "Soms staat er een stuk van de tegenstander in de weg. Weet je wat je dan mag doen? Het pakken! Dat heet slaan.",
    "Pak het zwarte stuk met je toren. Tik op je toren, en dan op het zwarte stuk.",
    "Nu met de loper. Hij slaat schuin, want zo loopt hij ook.",
    ...
    "Nu leren we iets heel belangrijks: schaak.",
    "Kijk, ik val de zwarte koning aan met mijn dame.",
    "Wordt de koning aangevallen? Dan heet dat schaak. De koning moet dan goed oppassen.",
    "En kan de koning niet meer ontsnappen? Dan is het schaakmat. Dan heb je gewonnen!",
    ...
    "Nu gaan we een echt partijtje spelen! Jij speelt met de witte stukken.",
    "Ik neem de zwarte. En jij mag beginnen, want wit zet altijd als eerste.",
    "Tik op een stuk en zet het op een groene stip. Heb je hulp nodig? Tik dan op de lamp. Veel plezier!",
...
for p in PRAISE:
    PHRASES.append(p + " Je hebt het sterretje te pakken!")
