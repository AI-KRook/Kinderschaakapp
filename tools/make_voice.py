...
PHRASES = [
    ...
    "Dit is de toren. Hij rijdt kaarsrecht, net als een trein op de rails. Naar voren, naar achteren, of opzij. Zo ver als hij wil! Maar nooit schuin. De toren is een sterk stuk.",
    "Dit is de loper. Hij glijdt altijd schuin, net een schaatser op het ijs. Zo ver als hij wil! Maar altijd schuin, nooit rechtdoor. En kijk: hij blijft steeds op dezelfde kleur.",
    ...
    "Dit is de dame. Zij is het allersterkste stuk! Zij mag rechtdoor, en ook schuin. Echt alle kanten op, zo ver als ze wil. Pas dus goed op haar.",
    "Dit is de koning. Hij is de baas van het spel. Maar wel een beetje langzaam: hij zet steeds maar één klein stapje. De koning is het belangrijkste stuk. Hem moet je goed beschermen.",
    "Dit is de pion, het kleinste soldaatje. Hij stapt vooruit, eentje tegelijk. De eerste keer mag hij er twee. Maar nooit achteruit! En weet je wat knap is? Komt een pion helemaal aan de overkant, dan wordt hij een dame!",
    ...
    "Pak het zwarte stuk dat gratis staat. Niemand verdedigt het!",
    "Tik op je toren en pak het stuk dat oplicht.",
    "Tik op je loper en sla het stuk schuin.",
    "Nu de vork! Eén stuk dat er twee tegelijk aanvalt. Heel slim.",
    "Nu een vork! Zet je paard op het vakje dat oplicht. Dan val je er twee tegelijk aan.",
    "Nog een vork! Zet je paard weer op het vakje dat oplicht.",
    "Zet je paard op het paarse vakje. Het valt de koning en de dame tegelijk aan.",
    "Een vork! Allebei tegelijk! Wat ben jij slim.",
    "En nu het mooiste: zet mat in één!",
    "En nu mat in één! Zet de zwarte koning schaakmat.",
    "De laatste! Zet weer mat in één. Je dame staat al klaar.",
